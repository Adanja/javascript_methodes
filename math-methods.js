...
function calculateDiameterCircle (diameter) {
    return Math.PI * (diameter);
}

console.log(calculateDiameterCircle(4));
...
let changingNumber = Math.random();

if (changingNumber <= 0.5) {
    console.log(changingNumber + " Het glas is halfleeg.");
} else {
    console.log(changingNumber + " Het glas is halfvol.");
    }
